...
villagerTradingHall.AddAccount(bankAccountOne);
villagerTradingHall.AddAccount(bankAccountTwo);
villagerTradingHall.AddAccount(bankAccountThree);
System.Console.WriteLine("---------------------");
...
villagerTradingHall.AddAccount(bankAccountFour);
villagerTradingHall.AddAccount(bankAccountFive);
villagerTradingHall.AddAccount(bankAccountSix);
villagerTradingHall.AddAccount(bankAccountSeven);
villagerTradingHall.AddAccount(bankAccountEight);
villagerTradingHall.AddAccount(bankAccountNine);
